%-------------------------------------------------
%
% SETUP - Configures the project environment for the EKF Tracking module.
...
function setup()
    ...
    disp('Setting up project: EKF Tracking...');
    ...
    asset_files = {'floor_texture.jpg', 'viena_texture.jpg', 'viena_capture.wrl', ...
                   'viena_scene_v1.wrl', 'path_viena_v1.mat', 'path_viena_v2.mat'};
