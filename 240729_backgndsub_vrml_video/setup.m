%-------------------------------------------------
%
% SETUP - Configures the project environment for the VRML Background Subtraction module.
...
function setup()
    ...
    disp('Setting up project: Background Subtraction...');
    ...
    asset_files = {'floor_texture.jpg', 'viena_background.jpg', 'viena_center_near.jpg', ...
                'viena_texture.jpg', 'viena_capture.wrl', 'viena_scene_v1.wrl'};
