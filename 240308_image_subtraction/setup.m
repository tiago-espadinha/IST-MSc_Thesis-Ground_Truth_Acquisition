%-------------------------------------------------
% 
% SETUP - Configures the project environment for the Image Subtraction module.
...
function setup()
    ...
    disp('Setting up project: Image Subtraction...');
    ...
    asset_files = {'viena_center_near.jpg', 'viena_background.jpg', 'Viena_30s.mp4', 'tracking_bbox.mat'};
