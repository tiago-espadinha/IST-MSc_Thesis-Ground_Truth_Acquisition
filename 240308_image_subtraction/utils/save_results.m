%-------------------------------------------------
%
% SAVE_RESULTS - Saves data, figures, images, or videos to the 'outputs' directory.
...
%                        - For videos (.mp4, .avi): this argument is not used
%                          as the function only returns the path.
%
% Outputs:
