%-------------------------------------------------
%
% SETUP - Configures the project environment for the Camera Calibration module.
% This script performs two main tasks:
% 1. Adds the project's directories (including 'utils' and 'demos') to the
%    MATLAB path to make its functions and scripts accessible.
...
function setup()
    ...
    disp('Setting up project: Camera Calibration...');
    ...
    asset_files = {'demo_cube.tif', 'floor_texture.jpg', 'viena_center_near.jpg', 'viena_vrml.tif', 'cam_calib_input.mat', 'homography_input.mat'};
