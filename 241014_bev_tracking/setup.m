%-------------------------------------------------
%
% SETUP - Configures the project environment for the BEV Tracking module.
...
function setup()
    ...
    disp('Setting up project: BEV Tracking...');
    ...
    asset_files = {'coords_bev.mat', 'coords_edge_6dof.mat', 'coords_edge_7dof.mat', ...
                   'coords_ground_truth.mat', 'homography.mat', 'img_names.mat', ...
                   'floor_texture.jpg', 'viena_center_far.jpg', 'viena_center_near.jpg', ...
                   'viena_left_far.jpg', 'viena_left_med.jpg', 'viena_left_near.jpg', ...
                   'viena_right_far.jpg', 'viena_right_med.jpg', 'viena_right_near.jpg', ...
                   'google_earth_coords.jpg'};
