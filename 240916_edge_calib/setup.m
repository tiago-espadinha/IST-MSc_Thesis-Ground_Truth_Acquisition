%-------------------------------------------------
%
% SETUP - Configures the project environment for the Edge Calibration module.
...
function setup()
    ...
    disp('Setting up project: Edge Calibration...');
    ...
    asset_files = {'viena_center_far.jpg', 'viena_center_near.jpg', 'viena_left_far.jpg', ...
               'viena_left_med.jpg', 'viena_left_near.jpg', 'viena_right_far.jpg', ...
               'viena_right_med.jpg', 'viena_right_near.jpg', 'viena_texture.jpg', ...
               'calibration_input.mat', 'coords_ground_truth.mat', 'viena_capture.wrl', ...
               'viena_scene_v2.wrl'};
